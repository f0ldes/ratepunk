        ...
        <div className={styles.footerLinks}>
            ...
            <div className={styles.socialsColumn}>
                ...
                <div>
                    <h1>Social</h1>
                    <div>
                        <a className={styles.socialIconStyle} href="https://www.instagram.com/" >
                            <img src="/assets/socials/instagram.svg" alt="instagram" />
                        </a>
                        <a className={styles.socialIconStyle} href="https://www.facebook.com/" >
                            <img src="/assets/socials/facebook.svg" alt="facebook" /> 
                        </a>
                        <a className={styles.socialIconStyle} href="https://www.linkedin.com/" >
                        ...
                        <a className={styles.socialIconStyle} href="https://www.tiktok.com/" >
